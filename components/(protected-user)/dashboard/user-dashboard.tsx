...
export default async function UserDashboard({ transactions }: UserDashboardProps) {
  const txArrLen = transactions.length
  const recentTransactions = transactions.slice(0, txArrLen > 8 ? 8 : txArrLen)
